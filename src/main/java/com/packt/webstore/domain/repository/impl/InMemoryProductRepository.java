...
public class InMemoryProductRepository implements ProductRepository {
	...
	public InMemoryProductRepository() {
		...
		tablet_Nexus.setDescription("Google Nexus 7 is the lightest 7 inch tablet with"
	...
	public Set<Product> filterProducts(BigDecimal lowPrice, BigDecimal highPrice, String manufacturer,
			String category) {
		Set<Product> byPrice = new HashSet<Product>(getProductsByPrice(lowPrice, highPrice));
